export const actions = {
    ...
    { "id": 19, "description": "'Змеи и лестницы' Следущие круг: действия, шипы и здоровье не используются в игре" },
   ...
   // { "id": 37, "description": "Исполни танец радости, чтобы пропустить действие следующей клетки." },
    ...
    { "id": 43, "description": `Валун! С 100 клетки к 1 катиться D20, он двигается на 1 клетку
       после хода каждого игрока и сносит каждого игрока до близжащего поворота, перепрыгнуть валун можно только выкинув больше 15 при столкновении с ним` },
   // { "id": 44, "description": "Используй свой ход, чтобы заменить одно правило игры на своё до следующего раунда." },
    ...
    { "id": 62, "description": "Зомби! Все неиспользованные фишки начинают с 100 клетки и идут навстречу игрокам к 1. Выкидаете D6 за каждого зомби после своего хода" },
    ...
    { "id": 68, "description": "Только Хардкор! Отныне умирая игрок выбывает из игры" },
