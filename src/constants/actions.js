export const actions = {
   ...
   // { "id": 37, "description": "Исполни танец радости, чтобы пропустить действие следующей клетки." },
    { "id": 38, "description": "Выдай одному игроку 'звание' или титул. До конца игры обращаться к нему можно только так, иначе не правильно назвавший идет на 3 клетки назад" },
   ...
   // { "id": 68, "description": "Получите право на два броска подряд в следущий ход. (Сходить можно только на один результат на выбор)" }, повтор
    { "id": 69, "description": "Вы можете отменить действие любого игрока один раз." },
  // { "id": 70, "description": "Создайте собственное правило на один круг." },
    ...
    { "id": 92, "description": "Шипы наносят двойной урон (всем и  всегда)" },
    { "id": 93, "description": "Брось кубик дважды и выбери лучшее число для следущего хода." },
    { "id": 94, "description": "В течении следущих 3 ходов, кубик за тебя кидает игрок слева. Если ты бросишь кубик за себя сам - оба возвращаетесь на 3 клетки назад и теряеете 1 здоровье" },
    ...
    { "id": 107, "description": "Следущее действие (Любого игрока) срабатывает на всех игроков (Все бонусы и штрафы сумируются)" },
    ...
    { "id": 145, "description": "Если кто то попадет на клетки 7, 22, 51 или 72 он выбывает из игры (Действует до конца игры) (Игрок может вернутся, если кто то восстановит ему здоровье)"  },
