export const actions = {
    ...
    { "id": 161, "description": "В порыве хаоса здоровье всех игроков перемешивается"},
    { "id": 162, "description": "В порыве баланса здоровье всех игроков приравнивается к броску D4 (одному на всех)"},
    { "id": 163, "description": "На своем следущем ходу, ты можешь двигаться сквозь стены (По вертикали и горизонтали)"},
    { "id": 164, "description": "Отныне сердца на клетках бесконечны для всех"},
    { "id": 165, "description": "Если кто то попадет на клетки 7, 22, 51 или 72 он выбывает из игры"}
]
}
